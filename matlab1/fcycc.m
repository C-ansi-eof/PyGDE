...
%
% Para el análisis posterior de cortocircuitos:
%
...
% *************************************************************************
%
fallos=input('¿Se van a estudiar fallos? s/n (s): ','s');
%fallos='n';
	if isempty(fallos)
		fallos='s';
   end
...
[Zn1,Zn2 Zn0]=cortofcc(fide,fids,nudos,nn,cnombre,lineas,nl,nudo1lin,nudo2lin,yppl,ypsl,yppl0,ypsl0,...
trafos,nt,nudo1traf,nudo2traf,yppt,ypst,yspt,ysst,y0t,rt,yppt0,ypst0,ysst0,unudos,Yred,Yred2,Yred0,scarga,sgen);
end
%
fclose('all');
